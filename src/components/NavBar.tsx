            ...
            >
              ...
              <AnimatePresence>
                {isServicesOpen && (
                  ...
                  >
                    <a href="#" className="block py-2 hover:text-[#BCFF03] transition-colors">Graphic Designing</a>
                    <a href="#" className="block py-2 hover:text-[#BCFF03] transition-colors">Video Editing</a>
                    <a href="#" className="block py-2 hover:text-[#BCFF03] transition-colors">Web Development</a>
                  </motion.div>
                )}
              </AnimatePresence>
            </div>
